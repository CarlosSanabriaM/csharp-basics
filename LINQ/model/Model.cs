    ...
    public class Model
    {
        ...
        static void ResetModel()
        {
            ...
            employees = new List<Employee> {
                new Employee ("Alvaro", "Alvarez", new DateTime(1945,10,19), "985 001", "alvaro@mail.es", "Cantabria", offices[0] ),
                new Employee ("Bernardo", "Bernardez", new DateTime(1973,12,09), "985 002", "bernardo@mail.es", "Asturias", offices[1]),
                new Employee ("Carlos", "Carlez", new DateTime(1969,10,03), "985 003", "carlos@mail.es", "Alicante", offices[4]),
                new Employee ("Dario", "Dariez", new DateTime(1973,12,16), "100 004", "dario@mail.es", "Cantabria", offices[2]),
                new Employee ("Eduardo", "Eduardez", new DateTime(1945,02,10), "985 005", "eduardo@mail.es", "Granada", offices[2]),
                new Employee ("Felipe", "Felipez", new DateTime(1950,02,20), "985 006", "felipe@mail.es", "Asturias", offices[1]),
                };
