...
{
    // TODO: EVERYTHING!!
    public class ColaConcurrenteReaderWriterLockSlim<T>
    {
        ...
        /// Crea una cola vacía.
        /// </summary>
        public ColaConcurrenteReaderWriterLockSlim()
        {
        ...
        public ColaConcurrenteReaderWriterLockSlim(T valor)
        {
        ...
        public ColaConcurrenteReaderWriterLockSlim(params T[] valores)
        {
